...
OPERATIONS = {
    1: {'name': 'MBInvertedConvLayer', 'kernel_size':3 , 'expand_ratio':3},
    2: {'name': 'MBInvertedConvLayer', 'kernel_size':3 , 'expand_ratio':6},
    3: {'name': 'MBInvertedConvLayer', 'kernel_size':5 , 'expand_ratio':3},
    4: {'name': 'MBInvertedConvLayer', 'kernel_size':5 , 'expand_ratio':6},
    5: {'name': 'MBInvertedConvLayer', 'kernel_size':7 , 'expand_ratio':3},
    6: {'name': 'MBInvertedConvLayer', 'kernel_size':7 , 'expand_ratio':6},
    7: {'name': 'ZeroLayer'},
}
